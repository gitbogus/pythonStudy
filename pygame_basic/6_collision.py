...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/sangmin/Desktop/git_practice/pygame_basic/character.png")
...
# 적 enemy캐릭터
enemy = pygame.image.load("C:/Users/sangmin/Desktop/git_practice/pygame_basic/enemy.png")
...
while running:
    dt = clock.tick(144) # 게임화면의 초당 프레임수를 설정
    ...
    character_rect = character.get.rect()
