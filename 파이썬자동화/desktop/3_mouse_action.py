...
# pyautogui.click(64, 17, duration=1) # 1초 동안 (64, 17) 좌표를 마우스 클릭
...
# pyautogui.dragTo(1514, 349) # 절대 좌표기준으로 x 1514, y349로 드래그

# pyautogui.scroll(300) # 양수이면 위 방향으로 300만큼 스크롤,  음수이면 아래방향으로 300만큼 스크롤.
